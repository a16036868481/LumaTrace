...
export function useLatestMetrics(metrics: MetricEvent[]) {
  return useMemo(
    () => ({
      ...
      gpu: getLatestMetricByName(metrics, "gpu_utilization"),
      memory: getLatestMetricByName(metrics, "memory_mb"),
      power: getLatestMetricByName(metrics, "power_w"),
      gpuTemperature: getLatestMetricByName(metrics, "gpu_temperature_c"),
